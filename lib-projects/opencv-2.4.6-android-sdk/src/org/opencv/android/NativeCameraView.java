...
/**
 * This class is an implementation of a bridge between SurfaceView and native OpenCV camera. Due to the big amount of work done, by the base class
 * this child is only responsible for creating camera, destroying camera and delivering frames while camera is enabled
 */
